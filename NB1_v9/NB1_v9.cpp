...
void UserMain( void* pd ){
	...
	while(1){
			...
			DSPIStart(3,IMU_command,IMU2_raw,24,NULL);//IMU3
			timer3->delay(0.019);
			...
			//printf("Z-Accel=%g count: %d\n",0.00025*IMU_data[2]/65536, NB_counter);
